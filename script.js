...
so<3>ng lyrics<4>`,
    ...
    {
        title: "בידיים חשופות",
        artist: "גלעד שגב וגלעד שמואלי",
        year: "2025",
        composer: "",
        album: "פרויקט גיבורים, לזכר יונתן אלעזרי",
        lang: "he",
        chords: ["Ebm", "Gb6", "Bmaj7", "Db(sus2)", "Abm", "Bbm", "Db", "Gb"],
        lyrics: `
        בית 1:
י<1>ונתן, יוש<2>ב בחדר, עם כ<3>ל החברים שלו.
פתא<1>ום שומ<2>ע צ<4>עק<3>ות, קרב של ירי<3>ות.
ה<5>וא יודע זה זמ<6>ן ללכת, ...<1> הג<5>יע הזמ<6>ן שלו.

        פזמון:
כמ<3>ו דוד המלך, ה<8>וא אחז באבן.
טיפ<5>ס על החומות, ריח<6>ף מעל גגות.
הא<3>יר להם ת'דרך, מ<8>ול היריות- ביד<5>יים חשופ<6>ות.`,
        easiestKeyShift: 0.5
    },
    {
